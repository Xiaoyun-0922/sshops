...
This skill is the agent wrapper for the bundled SSH toolkit in `scripts/`. The toolkit is the product surface; the skill defines the safe workflow and which entrypoint to use.
